/*
 * ============================================================================
 * ChartEditorNew.cs - DEPRECATED (참고용으로 보존)
 * ============================================================================
 *
 * 이 파일은 새로운 통합 ChartEditor.cs로 대체되었습니다.
 *
 * 대체 파일: Assets/edit/ChartEditor.cs
 * 대체 날짜: 2025-10-25
 *
 * 이 코드는 참고 및 비교 목적으로만 유지됩니다.
 * 실제 사용하지 마세요! (전체 주석 처리됨)
 *
 * 새 ChartEditor.cs의 개선 사항:
 * - 롱노트 양방향 배치 지원
 * - Undo/Redo 시스템 (최대 50단계)
 * - 그리드 스냅 시스템 (G키 전환)
 * - 키보드 단축키 (Ctrl+S, Ctrl+Z, Space 등)
 * - 편집 범위 토글 (T키: 노트별 ↔ 마디별)
 * - DEVELOPMENT_TODO.md의 모든 요구사항 반영
 *
 * ============================================================================
 */
